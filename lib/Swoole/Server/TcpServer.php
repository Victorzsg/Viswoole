...
class TcpServer extends BaseServer {
    ...
    public function __construct($config = array()) {
        ...
        in_array("post", $config) && $this->port = $config["post"];
        return new swoole_server($this->host, $this->port, SWOOLE_BASE);
    }
    ...
    public function onStart(swoole_server $serv, $worker_id) {
